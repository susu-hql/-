<template>
  <div class="order">
      ...
      <!-- <el-select v-model="searchOderType" placeholder="订单类型" class="search">
        <el-option
...
export default {
  ...
  methods:{
   searchOrder:function(){    // 点击查询
     this.getOrderList1();
     console.log('查询,',this.searchOderState);
   },
   ...
   getOrderList1:function(){    // 获取所有的估损预约订单
     console.log('查询,',this.searchOderState);
     this.axios  
          .post("/back/assessmentOrder/findList",{
            page:this.page,    //当前页
