...
export default {
  ...
  methods: {
    ...
    tj: function(e) {
      ...
      this.addarr(this.b3);
      console.log("122334111", this.arr);
       this.get(this.arr);
    ...
    /*   this.$store.getid(this.arr);
      this.$store.get(this.sx); */
    ...
    getalltype: function() {
      ...
      this.axios
        ...
        .then(res => {
          ...
          console.log(
            "保险信息1",
            res.data.data[2].insuranceList[1].coverageList
          );
          console.log(
            "保险信息2",
            res.data.data[2].insuranceList[3].coverageList
          );
          console.log(
            "保险信息3",
            res.data.data[2].insuranceList[4].coverageList
          );
          console.log(
            "保险信息4",
            res.data.data[2].insuranceList[7].coverageList
          );
